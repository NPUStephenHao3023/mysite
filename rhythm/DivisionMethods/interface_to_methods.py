...
def interface_to_generate_img(file_name, method, args, test_or_not):
...
# print(interface_to_generate_img("data1024", "2d_equal_grid", [2], False))
# interface_to_generate_img("data1024", "time_space", [1, 2], True)
# interface_to_generate_img("data1024", "time_space", [2, 2], True)
